...
def run_module():
    ...
    module_args.update(dict(ip=dict(required=True), service_name=dict(required=True)))
    ...
    # Move the ip
    client.post(f"/ip/{ip}/move", nexthop=None, to=service_name)
